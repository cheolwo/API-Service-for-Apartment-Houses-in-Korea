...
namespace 국토교통부_공공데이터Common.개발사용료_정보제공_서비스.ResponseModel.난방비
{
    [XmlRoot("response")]
    public class 난방비Response
    {
        [XmlElement("header")]
    ...
    public class Item
    {
        ...
        [XmlElement("heatC")]
        public long HeatC { get; set; } // 난방 공용 금액, 크기: 22, 필수

        [XmlElement("heatP")]
        public long HeatP { get; set; } // 난방 전용 금액, 크기: 22, 필수
    }
}
