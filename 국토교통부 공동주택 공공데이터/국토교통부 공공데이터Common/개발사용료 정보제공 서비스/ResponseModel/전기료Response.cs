...
namespace 국토교통부_공공데이터Common.개발사용료_정보제공_서비스.ResponseModel.전기료
{
    [XmlRoot("response")]
    public class 전기료Response
    {
        [XmlElement("header")]
    ...
    public class Item
    {
        ...
        [XmlElement("electC")]
        public long ElectC { get; set; } // 전기 공용 금액, 크기: 22, 필수

        [XmlElement("electP")]
        public long ElectP { get; set; } // 전기 전용 금액, 크기: 22, 필수
    }
