...
namespace 국토교통부_공공데이터Common.공용관리비_정보제공서비스.ResponseModel.기타부대비용
{
    [XmlRoot("response")]
    public class 기타부대비용Response
    {
        [XmlElement("header")]
    ...
    public class Item
    {
        ...
        public long CareItemCost { get; set; } // 관리용품구입비, 크기: 22, 필수

        [XmlElement("accountingCost")]
        public long AccountingCost { get; set; } // 전문가자문비 등, 크기: 22, 필수

        [XmlElement("hiddenCost")]
        public long HiddenCost { get; set; } // 잡비, 크기: 22, 필수
    }
